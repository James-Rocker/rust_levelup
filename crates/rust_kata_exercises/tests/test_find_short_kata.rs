...
mod tests {
    ...
    fn fixed_tests() {
        ...
        do_test(
            "21inc Dash LiteCoin Ripple MadeSafeCoin Bitcoin Bitcoin Bitcoin Monero Ripple Bitcoin",
            4,
        );
        ...
        do_test(
            "Steem LiteCoin Bitcoin BTC Waves Bitcoin Classic Ethereum",
            3,
        );
        do_test(
            "Ripple ProofOfWork MadeSafeCoin Monero Ripple 21inc Waves Monero Dash",
            4,
        );
        ...
        do_test(
            "Lisk Steem Monero Waves Lisk Factom Classic Waves Dogecoin Ripple Steem",
            4,
        );
        do_test(
            "Lisk Classic Waves MadeSafeCoin LiteCoin DarkCoin 21inc Ethereum LiteCoin BTC",
            3,
        );
        ...
        do_test(
            "Classic Lisk Bitcoin Mine LiteCoin Factom Ripple BTC 21inc Ethereum LiteCoin Lisk",
            3,
        );
        do_test(
            "Monero ProofOfWork Dash LiteCoin Dash Dash ProofOfWork Ethereum Bitcoin DarkCoin",
            4,
        );
        ...
        do_test(
            "Monero MadeSafeCoin DarkCoin MadeSafeCoin Lisk Waves BTC DarkCoin",
            3,
        );
        ...
        do_test("21inc", 5);
        do_test(
            "Mine ProofOfStake Monero Lisk BTC Steem Steem Monero Classic ProofOfStake Steem",
            3,
        );
        ...
        do_test(
            "DarkCoin Waves MadeSafeCoin ProofOfWork Dash Mine ProofOfWork",
            4,
        );
        do_test(
            "Ripple MadeSafeCoin Dogecoin Ripple Waves Ethereum ProofOfStake 21inc",
            5,
        );
        ...
        do_test(
            "BTC ProofOfWork MadeSafeCoin Bitcoin Bitcoin Mine Mine Steem Steem",
            3,
        );
    }
